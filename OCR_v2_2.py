    ...
    try:
        ...
        for semester_label, courses in transcript["semesters"]:
            ...
            for course in courses:
                ...
                # 接续学期: look up by "YEAR SEASON" e.g. "2025 FALL", case-insensitive
                term_key  = " ".join(f"{year} {ext_term}".upper().split())
        ...
        for semester_label, courses in transcript["semesters"]:
            ...
            for course in courses:
                ...
                row = [zjuid, transcript["uid"], transcript["name"], "UGRD", "ZJUNV",
                       ...
                       term_map.get(" ".join(f"{year} {ext_term}".upper().split()), ""),
                       "1", year, ext_term,
...
def main():
    ...
    tk.Label(banner,
             text="ZJUI-UIUC Transcript Parser v2.1",
    ...
    ttk.Button(right, text="Term Code Map", style="Gold.TButton",
